...
public class DiviserGraphe {
    ...
    /**
     * Classe utilitaire : constructeur prive pour empecher l'instanciation.
     */
    private DiviserGraphe() {
    }

    /**
     * Decoupe le graphe global en deux sous-graphes, chacun destine a un camion.
     * Le depot (sommet d'index 0) est present en premiere position des deux
     * sous-graphes ; les autres sommets sont repartis entre les deux zones.
     *
     * @param grapheGlobal le graphe complet a partitionner
     * @return un tableau de deux sous-graphes {@code [zoneCamion1, zoneCamion2]}
     */
